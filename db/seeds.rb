...
restaurant = Restaurant.create({name: "Chilis", cuisine: "Mexican", address: "123 Main St." city: "Rochester", state: "NY", zip_code: "12345"})
review = Review.create({rating: 3, recommendation: "The queso is great!", user_id: user.id, restaurant_id: restaurant.id})

restaurant = Restaurant.create({name: "Macaroni Grill", cuisine: "Italian", address: "123 Sesame St.", city: "Albany", state: "NY", zip_code: "67890"})
...
restaurant = Restaurant.create({name: "Red Lobster", cuisine: "Seafood", address: "185 Leroy Ave.", city: "Buffalo", state: "NY", zip_code: "11223"})
